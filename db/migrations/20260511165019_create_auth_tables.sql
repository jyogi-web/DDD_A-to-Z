...
CREATE TABLE "github_accounts" ("github_id" bigint NOT NULL, "user_id" text NOT NULL, "username" text NOT NULL, "avatar_url" text NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, PRIMARY KEY ("github_id"), CONSTRAINT "github_accounts_user_id_key" UNIQUE ("user_id"), CONSTRAINT "github_accounts_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
